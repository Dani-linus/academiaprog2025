...
Uma calculadora simples que permite 
realizar as quatro operações, além de permitir a visualização da tabuada e o histórico de registros.

## Funcionalidades

- **Operações básicas:** Realiza somas, subtrações, divisões e multiplicações com facilidade.
